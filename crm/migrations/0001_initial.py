# Generated by Django 4.1.4 on 2023-02-05 01:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repaid_by_redemption', models.FileField(blank=True, null=True, upload_to='Отступные документы/%Y/%m/%d', verbose_name='Отступные документы')),
                ('court_documents', models.FileField(blank=True, null=True, upload_to='Судебные документы/%Y/%m/%d', verbose_name='Судебные документы')),
                ...
                ('id_credit_spec', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Кредитный специалист')),
            ],
            options={
                'verbose_name': 'ЧП/ИП',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit_type', models.CharField(choices=[('LS', 'Лизинг'), ('CR', 'Кредит')], max_length=30, verbose_name='Тип кредита')),
                ('repaid_by_redemption', models.FileField(blank=True, null=True, upload_to='Отступные документы/%Y/%m/%d', verbose_name='Отступные документы юр.лица')),
                ('court_documents', models.FileField(blank=True, null=True, upload_to='Судебные документы/%Y/%m/%d', verbose_name='Судебные документы юр.лица')),
                ('status', models.CharField(choices=[('success', 'Выдан'), ('processing', 'Обработка'), ('discussion', 'На рассмотрении'), ('denied', 'Отказано'), ('payback', 'Погашен за счет отступных'), ('judicial', 'Судебный')], max_length=30, verbose_name='Статус клиента')),
                ('credit_sum', models.CharField(max_length=30, verbose_name='Сумма кредита')),
                ('credit_history', models.FileField(blank=True, default='Кредитная история отсутствует', null=True, upload_to='client_credit_history/%Y/%m/%d', verbose_name='Кредитная история')),
                ...
                ('own_contribution', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Размер собвственного взноса')),
                ...
                ('id_credit_spec', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Кредитный специалист')),
                ('id_property', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Entity', to='crm.property', verbose_name='Залоговое имущество')),
                ('souce_of_income', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='crm.activity', verbose_name='Источник дохода')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='crm.client', verbose_name='ЧП/ИП')),
                ('id_entity', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='crm.entity', verbose_name='Юридическое лицо')),
                ('id_spec', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Кредитный спец')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(default='+996', max_length=15, verbose_name='Номер телефона')),
                ...
                ('client_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='conversation', to='crm.client', verbose_name='ЧП/ИП')),
                ('entity_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='conversation', to='crm.entity', verbose_name='Юр.лицо')),
            ],
            options={
